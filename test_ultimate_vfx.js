...
async function runTests() {
  ...
  assert.strictEqual(swText.includes("necromancer-expedition-v33"), true, "service-worker.js CACHE_NAME must be v33");
  assert.strictEqual(swText.includes("20260731-22"), true, "service-worker.js APP_SHELL must contain 20260731-22 VFX query parameters");
  assert.strictEqual(htmlText.includes("20260731-22"), true, "index.html must contain 20260731-22 VFX asset query parameters");
