...
const APP_SHELL = [
  ...
  "./art/v2-style/ui/unit-card-ice-lord.png?v=11",
  "./art/v2-style/ui/unit-card-yeti.png?v=11",
  "./art/v2-style/ui/unit-card-guardian-seed.png?v=11",
  "./art/v2-style/ui/unit-card-plague-doctor.png?v=11",
