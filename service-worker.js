const CACHE_NAME = "necromancer-expedition-v220";
const APP_SHELL = [
  "./",
  "./index.html",
  "./v2.html",
  ...
  "./v2-unit-size.js?v=5",
  "./v2-unit-cards.js?v=17",
  "./art/v2-style/ui/unit-card-corpse-slime.png?v=13",
  "./art/v2-style/ui/unit-card-minotaur.png?v=13",
  "./art/v2-style/ui/unit-card-plague-frog.png?v=13",
  "./art/v2-style/ui/unit-card-ice-lord.png?v=13",
  "./art/v2-style/ui/unit-card-yeti.png?v=13",
  "./art/v2-style/ui/unit-card-guardian-seed.png?v=13",
  "./art/v2-style/ui/unit-card-plague-doctor.png?v=13",
  "./art/v2-style/ui/unit-card-ghoul.png?v=13",
  "./art/v2-style/ui/unit-card-goblin-chief.png?v=13",
  "./art/v2-style/ui/unit-card-goblin-soldier.png?v=13",
  "./art/v2-style/ui/unit-card-goblin-commoner.png?v=13",
  "./art/v2-style/ui/unit-card-sea-wolf.png?v=13",
  "./art/v2-style/ui/unit-card-grave-priest.png?v=13",
  "./art/v2-style/ui/unit-card-abyss-eye.png?v=13",
  "./art/v2-style/ui/unit-card-doom-executor.png?v=13",
  "./art/v2-style/ui/unit-card-death-knight.png?v=13",
  "./art/v2-style/ui/unit-card-hell-mantis.png?v=13",
  "./art/v2-style/ui/unit-card-scorpion-knight.png?v=13",
  "./art/v2-style/ui/unit-card-ancient-treant.png?v=13",
  "./art/v2-style/ui/unit-card-stone-golem.png?v=13",
