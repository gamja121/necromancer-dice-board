...
assert(worker.includes('necromancer-expedition-v181'), "Service worker cache version was not advanced.");
assert(worker.includes("v2-auto-battle-practice.html"), "Auto battle page is not cached.");
assert(worker.includes("v2-auto-battle-practice.css?v=24"), "Turn dice, lineup picker and illustrated unit info styling is not cached.");
assert(worker.includes("v2-auto-battle-practice.js?v=29") && worker.includes("v2-battle-brands.js?v=2"), "Turn-based auto battle, lineup picker and brands are not cached.");
