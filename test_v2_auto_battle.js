...
assert(worker.includes('necromancer-expedition-v221'), "Service worker cache version was not advanced.");
...
assert(worker.includes("v2-unit-cards.js?v=18"), "Summoned-unit card mapping is not cached.");
for (const slug of ["goblin-commoner","sea-wolf","grave-priest","abyss-eye","doom-executor","death-knight","hell-mantis","scorpion-knight","ancient-treant","stone-golem","kraken","crystal-devourer","skeleton-spear","skeleton-archer","spider-knight"]) assert(worker.includes(`art/v2-style/ui/unit-card-${slug}.png?v=14`), `Replacement ${slug} card art is not cached.`);
