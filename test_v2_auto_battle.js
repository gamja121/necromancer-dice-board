...
assert(worker.includes('necromancer-expedition-v178'), "Service worker cache version was not advanced.");
...
assert(worker.includes("v2-auto-battle-practice.js?v=26") && worker.includes("v2-battle-brands.js?v=2"), "Turn-based auto battle, lineup picker and brands are not cached.");
