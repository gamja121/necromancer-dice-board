...
assert(worker.includes('necromancer-expedition-v239'), "Service worker cache version was not advanced.");
...
assert(worker.includes("v2-auto-battle-practice.js?v=68") && worker.includes("v2-legions.js?v=3") && worker.includes("v2-battle-brands.js?v=3"), "Turn-based status battle logic is not cached.");
...
assert(infoContext.unitInfoImage.attrs.href === deathKnight.infoPortrait && deathKnight.infoPortrait === "art/v2-style/ui/info-portraits/death-knight.png?v=1", "Info window must use the dedicated Death Knight portrait.");
