...
assert(css.includes(".unit-info-panel") && css.includes("background: transparent; box-shadow: none;"), "Unit information window must not add a rectangular background or black shadow around the cutout.");
