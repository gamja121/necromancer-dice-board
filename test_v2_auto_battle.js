...
assert(worker.includes('necromancer-expedition-v177'), "Service worker cache version was not advanced.");
...
assert(worker.includes("v2-auto-battle-practice.js?v=25") && worker.includes("v2-battle-brands.js?v=2"), "Turn-based auto battle, lineup picker and brands are not cached.");
