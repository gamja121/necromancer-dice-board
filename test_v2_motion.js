...
assert(serviceWorker.includes("necromancer-expedition-v110"), "Service worker cache version was not bumped.");
...
console.log("SUCCESS: 20 unit motion test integrations, including Grave Priest, passed.");
