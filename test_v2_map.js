...
assert(html.includes("v2-map-practice.js?v=12") && html.includes("v2-map-practice.css?v=9") && html.includes("v2-sfx.js?v=3"), "The map page must load targeting and mobile sound effects.");
...
assert(worker.includes("v2-map-practice.js?v=12") && worker.includes("v2-map-practice.css?v=9") && worker.includes("v2-sfx.js?v=3"), "The targeting and mobile sound logic is not cached.");
