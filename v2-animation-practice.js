(() => {
  ...
  const UNITS = Object.freeze({
    ...
    "ice-princess": { name: "얼음 여왕", runtimeSheet: true, counts: { attack: 6, hit: 4, death: 5 } },
    ...
    "doom-executor": { name: "석익 악마", root: "art/v2-style/animation-test-frames/doom-executor/", counts: { attack: 5, hit: 4, death: 5 } },
    ...
    "corpse-slime": { name: "시체 슬라임", root: "art/v2-style/animation-test-frames/corpse-slime/", counts: { attack: 7, hit: 4, death: 5 } },
