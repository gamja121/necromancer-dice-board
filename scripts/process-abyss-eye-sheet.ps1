...
public static class AbyssEyeSheetProcessor
{
    ...
    public static void Process(string inputPath, string outputDirectory)
    {
        ...
        Rectangle[][] cells = {
            new Rectangle[] {
                ...
                Rectangle.FromLTRB(571, 0, 815, 198), Rectangle.FromLTRB(816, 0, 1090, 198),
...
[AbyssEyeSheetProcessor]::Process((Resolve-Path $InputPath), $OutputDirectory)
Write-Output "Processed abyss eye sheet into $OutputDirectory"
