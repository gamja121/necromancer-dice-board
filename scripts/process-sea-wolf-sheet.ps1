...
public static class SeaWolfSheetProcessor
{
    ...
    public static void Process(string inputPath, string outputDirectory)
    {
        ...
        Rectangle[][] cells = {
            new Rectangle[] {
                ...
                Rectangle.FromLTRB(536, 0, 780, 198), Rectangle.FromLTRB(797, 0, 1090, 198),
...
[SeaWolfSheetProcessor]::Process((Resolve-Path $InputPath), $OutputDirectory)
Write-Output "Processed sea wolf sheet into $OutputDirectory"
