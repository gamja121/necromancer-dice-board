...
public static class MushroomSoldierSheetProcessor
{
    ...
    public static void Process(string inputPath, string outputDirectory)
    {
        ...
        Rectangle[][] cells = {
            new Rectangle[] {
                Rectangle.FromLTRB(132, 0, 328, 198), Rectangle.FromLTRB(335, 0, 530, 198),
                Rectangle.FromLTRB(536, 0, 780, 198), Rectangle.FromLTRB(864, 0, 989, 198),
                Rectangle.FromLTRB(1072, 0, 1263, 198)
            },
            new Rectangle[] {
            ...
            new Rectangle[] {
                Rectangle.FromLTRB(132, 401, 306, 576), Rectangle.FromLTRB(313, 401, 506, 576),
                Rectangle.FromLTRB(512, 401, 704, 576), Rectangle.FromLTRB(711, 401, 907, 576),
                Rectangle.FromLTRB(914, 401, 1111, 576), Rectangle.FromLTRB(1118, 401, 1280, 576)
            }
        };
...
[MushroomSoldierSheetProcessor]::Process((Resolve-Path $InputPath), $OutputDirectory)
Write-Output "Processed mushroom soldier sheet into $OutputDirectory"
