...
public static class SkeletonArcherSheetProcessor
{
    ...
    public static void Process(string inputPath, string outputDirectory)
    {
        ...
        Rectangle[][] cells = {
            new Rectangle[] {
                Rectangle.FromLTRB(132, 0, 334, 198), Rectangle.FromLTRB(335, 0, 570, 198),
                Rectangle.FromLTRB(571, 0, 815, 198), Rectangle.FromLTRB(816, 0, 1045, 198),
                Rectangle.FromLTRB(1046, 0, 1280, 198)
            },
            new Rectangle[] {
...
[SkeletonArcherSheetProcessor]::Process((Resolve-Path $InputPath), $OutputDirectory)
Write-Output "Processed skeleton archer sheet into $OutputDirectory"
