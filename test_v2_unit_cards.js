...
for (const slug of ['corpse-slime','minotaur','plague-frog','ice-lord','yeti','goblin-commoner','sea-wolf','grave-priest','abyss-eye','doom-executor','death-knight','hell-mantis','scorpion-knight','ancient-treant','stone-golem','kraken','crystal-devourer','skeleton-spear','skeleton-archer','spider-knight','raging-treant','cerberus','mushroom-soldier','goblin-rider','orc-warrior']) {
...
api.sync(field,units,u=>selected=u);
assert.equal(field.children.length,1);
assert(units[0].infoCard.children[0].style.backgroundImage.includes('unit-card-guardian-seed.png?v=15'));
