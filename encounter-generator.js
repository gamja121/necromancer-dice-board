...
(function (root, factory) {
  ...
  function getFallbackTemplateEncounters(seed) {
    ...
    const baseList = [
      ...
      ["plagueFrog", "seaWolf", "scorpionKnight", "siren"],
      ["worm", "goblinChief", "ancientTreant"],
      ["goblinSoldier", "hellMantis", "icePrincess", "abyssHarpy"],
      ["spear", "seaWolf", "plague", "hydra"],
      ["plagueFrog", "skeletonSummoner", "goblinRider", "forestFairy"],
      ["iceLord", "ancientTreant", "kraken", "poisonMushroom"],
      ["goblinSoldier", "yeti", "crystalDevourer", "mummyGuardian"],
      ["archer", "ghoul", "knight", "soulReaper"],
      ["yeti", "golem", "spiderQueen", "boneHound"],
      ["ghoul", "yeti", "skeletonSummoner", "mimic"],
